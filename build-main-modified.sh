...
##### modified Aug 18:
# crontab with sleep 20 and ionice
# copy build-main-modified.sh to /home/pi/Super-AIO/build
# commented: # Fix splashsreen sound
...
@reboot /bin/sleep 20 && /usr/bin/nice -n 19 /usr/bin/ionice -c3 /usr/bin/python /home/pi/Super-AIO/release/saio/saio-osd.py
"
if [[ $2 != "" ]] ; then
  BRANCH=$2
else
...
### copy new build-main to $Githubdir/build
execute "cp build-main-modified.sh $GITHUBDIR/build/"
